// the form in the view for when a video is clicked in studio page
                            ...
                            <div className="p-4 flex flex-col gap-y-6">
                                    ...
                                    <div className="flex flex-col gap-y-1">
                                        ...
                                        <div className="flex items-center gap-x-2">
                                            ...
                                            <Button type="button" variant="ghost" size="icon" className="shrink-0" onClick={onCopy} disabled={isCopied}>
                                                {!isCopied ? <CopyIcon/> : <CopyCheckIcon/>}
                                            </Button>
                                        </div>
                                    </div>
                                </div>
                                {/*  Video & Subtitle Status */}
                                ...
                                <div className="flex justify-between items-center">
                                    <div className="flex flex-col gap-y-1">
                                        ...
                                        <p className="text-sm">{ snakeCaseToTitle(video.muxTrackStatus || "no audio" )}</p>
                                    </div>
                                </div>
